...
if you put omega_OR to a lower value. If you see a different behaviour, let me know.
...
-other algorithms for gauge-fixing other than overrelaxation
-other gfix_proxy apart from e2 and theta
-gently pause or stop the running program
-signal handling. Program will terminate abruptly if termination signals are passed
-support for GPU acceleration
-other formats for configurations different from the headerless SCIDAC
-Nc different from 3
-lattices with different number of points in different spatial directions
-gauge field in a representation different from the fundamental
-number of dimensions different from 4
-support for custom precision datatypes