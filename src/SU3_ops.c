...
inline void subtractionHermConjTrless3x3(const Mtrx3x3* restrict u,
    ...
    LOOP_3(a) {
        tr += u_minus_udag_trless->m[ELEM_3X3(a, a)] = 2 * I * cimag(u->m[ELEM_3X3(a, a)]);
    }
    ...
    LOOP_3X3(a, b) {
        if (a != b) {
            u_minus_udag_trless->m[ELEM_3X3(a, b)] = u->m[ELEM_3X3(a, b)] - conj(u->m[ELEM_3X3(b, a)]);
            u_minus_udag_trless->m[ELEM_3X3(b, a)] = u->m[ELEM_3X3(b, a)] - conj(u->m[ELEM_3X3(a, b)]);
        }
    }
}
...
inline void updateSubLosAlamos(Mtrx3x3* restrict w, const Submtrx sub) {
    ...
    LA_sub_update.m[0] = creal(w->m[ELEM_3X3(a, a)] + w->m[ELEM_3X3(b, b)]);
    LA_sub_update.m[1] = -cimag(w->m[ELEM_3X3(a, b)] + w->m[ELEM_3X3(b, a)]);
    LA_sub_update.m[2] = -creal(w->m[ELEM_3X3(a, b)] - w->m[ELEM_3X3(b, a)]);
    LA_sub_update.m[3] = -cimag(w->m[ELEM_3X3(a, a)] - w->m[ELEM_3X3(b, b)]);
...
inline double inverse3x3(const Mtrx3x3* restrict a,
    ...
    if (a_det != 0.0) {
        a_inv->m[ELEM_3X3(0, 0)] = (a->m[ELEM_3X3(1, 1)] * a->m[ELEM_3X3(2, 2)] - a->m[ELEM_3X3(1, 2)] * a->m[ELEM_3X3(2, 1)]) / a_det;
        a_inv->m[ELEM_3X3(0, 1)] = (a->m[ELEM_3X3(0, 2)] * a->m[ELEM_3X3(2, 1)] - a->m[ELEM_3X3(0, 1)] * a->m[ELEM_3X3(2, 2)]) / a_det;
        a_inv->m[ELEM_3X3(0, 2)] = (a->m[ELEM_3X3(0, 1)] * a->m[ELEM_3X3(1, 2)] - a->m[ELEM_3X3(0, 2)] * a->m[ELEM_3X3(1, 1)]) / a_det;

        a_inv->m[ELEM_3X3(1, 0)] = (a->m[ELEM_3X3(1, 2)] * a->m[ELEM_3X3(2, 0)] - a->m[ELEM_3X3(1, 0)] * a->m[ELEM_3X3(2, 2)]) / a_det;
        a_inv->m[ELEM_3X3(1, 1)] = (a->m[ELEM_3X3(0, 0)] * a->m[ELEM_3X3(2, 2)] - a->m[ELEM_3X3(0, 2)] * a->m[ELEM_3X3(2, 0)]) / a_det;
        a_inv->m[ELEM_3X3(1, 2)] = (a->m[ELEM_3X3(0, 2)] * a->m[ELEM_3X3(1, 0)] - a->m[ELEM_3X3(0, 0)] * a->m[ELEM_3X3(1, 2)]) / a_det;

        a_inv->m[ELEM_3X3(2, 0)] = (a->m[ELEM_3X3(1, 0)] * a->m[ELEM_3X3(2, 1)] - a->m[ELEM_3X3(1, 1)] * a->m[ELEM_3X3(2, 0)]) / a_det;
        a_inv->m[ELEM_3X3(2, 1)] = (a->m[ELEM_3X3(0, 1)] * a->m[ELEM_3X3(2, 0)] - a->m[ELEM_3X3(0, 0)] * a->m[ELEM_3X3(2, 1)]) / a_det;
        a_inv->m[ELEM_3X3(2, 2)] = (a->m[ELEM_3X3(0, 0)] * a->m[ELEM_3X3(1, 1)] - a->m[ELEM_3X3(0, 1)] * a->m[ELEM_3X3(1, 0)]) / a_det;
...
inline static void crossproductConj(Vec3 u,
    ...
    u_cross_v_star->m[0] = conj(u.m[1] * v.m[2] - u.m[2] * v.m[1]);

    u_cross_v_star->m[1] = conj(u.m[2] * v.m[0] - u.m[0] * v.m[2]);

    u_cross_v_star->m[2] = conj(u.m[0] * v.m[1] - u.m[1] * v.m[0]);
}
...
void decomposeAlgebraSU3(const Mtrx3x3* restrict a,
    ...
    a_components->m[1] = (creal(a->m[ELEM_3X3(0, 1)]) + creal(a->m[ELEM_3X3(1, 0)]));

    a_components->m[2] = (-cimag(a->m[ELEM_3X3(0, 1)]) + cimag(a->m[ELEM_3X3(1, 0)]));

    a_components->m[3] = (creal(a->m[ELEM_3X3(0, 0)]) - creal(a->m[ELEM_3X3(1, 1)]));

    a_components->m[4] = (creal(a->m[ELEM_3X3(0, 2)]) + creal(a->m[ELEM_3X3(2, 0)]));

    a_components->m[5] = (-cimag(a->m[ELEM_3X3(0, 2)]) + cimag(a->m[ELEM_3X3(2, 0)]));

    a_components->m[6] = (creal(a->m[ELEM_3X3(1, 2)]) + creal(a->m[ELEM_3X3(2, 1)]));

    a_components->m[7] = (-cimag(a->m[ELEM_3X3(1, 2)]) + cimag(a->m[ELEM_3X3(2, 1)]));

    a_components->m[8] = (creal(a->m[ELEM_3X3(0, 0)]) + creal(a->m[ELEM_3X3(1, 1)]) - 2.0 * creal(a->m[ELEM_3X3(2, 2)])) / sqrt(3.0);
}
