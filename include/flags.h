...
//  Uncomment if reading gauge-transf in float and need to convert to double precision

// #define  CONV_GT_FROM_WORKING_PRECISION
//  Uncomment if writing gauge-transf in float and need to convert from double precision
