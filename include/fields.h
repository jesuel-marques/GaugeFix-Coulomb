...
#define GET_LINK(U, position, mu) U + ((((position.pos[T_INDX] * lattice_param.n_SPC + position.pos[Z_INDX]) * lattice_param.n_SPC + position.pos[Y_INDX]) * lattice_param.n_SPC + position.pos[X_INDX]) * DIM + mu)
